#ifndef G4d2oSpecialElectronGun_h
#define G4d2oSpecialElectronGun_h 1
...
class G4d2oSpecialElectronGun : public G4d2oPrimaryGeneratorAction
{
    RQ_OBJECT("G4d2oSpecialElectronGun")

public:
    G4d2oSpecialElectronGun();
    ~G4d2oSpecialElectronGun();
...
}; //END of class G4d2oSpecialElectronGun
