#ifndef G4d2oPhotonGun_h
#define G4d2oPhotonGun_h 1
...
class G4d2oPhotonGun : public G4d2oPrimaryGeneratorAction
{
    RQ_OBJECT("G4d2oPhotonGun")
...
private:
    ...
    G4int photonsPerEvent;
    
    G4int theEventNum;
        
}; //END of class G4d2oPhotonGun
