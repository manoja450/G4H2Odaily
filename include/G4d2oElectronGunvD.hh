#ifndef G4d2oElectronGunvD_h
#define G4d2oElectronGunvD_h 1
...
class G4d2oElectronGunvD : public G4d2oPrimaryGeneratorAction
{
    RQ_OBJECT("G4d2oElectronGunvD")
...
}; //END of class G4d2oElectronGunvD
