#ifndef G4d2oElectronGunvO_h
#define G4d2oElectronGunvO_h 1
...
class G4d2oElectronGunvO : public G4d2oPrimaryGeneratorAction
{
    RQ_OBJECT("G4d2oElectronGunvO")
...
}; //END of class G4d2oElectronGunvO
