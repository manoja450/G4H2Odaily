...
G4d2oSpecialElectronGun::G4d2oSpecialElectronGun()
{
    
    G4cout << "\tConstructing G4d2oSpecialElectronGun..." ;
...
G4d2oSpecialElectronGun::~G4d2oSpecialElectronGun()
{
	...
	G4cout<<"Deleting G4d2oSpecialElectronGun...";
...
void G4d2oSpecialElectronGun::GeneratePrimaries(G4Event* anEvent)
{
    ...
    sourceEnergy = (input->GetSpecialEnergy()) * MeV;
